    ...
    for step in workflow["steps"]:
        if step.get("iterate_over"):
            ...
            for item in items:
                ...
                data = json.loads(result.text) if step.get("output_format") == "json" else result.text
        ...
        raw_results[step["id"]] = json.loads(result.text) if step.get("output_format") == "json" else result.text
